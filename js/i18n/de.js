export default {
  ...
  "project.hint": "Netz, Textur-Einstellungen und Flächenmasken in einer Datei speichern oder laden.",
  "project.save": "Projekt speichern…",
  "project.saveTitle": ".zip mit Modell, Profil und gemalten Masken herunterladen",
  "project.open": "Projekt öffnen…",
  "project.openTitle": "Gespeichertes BumpMesh-Projekt (.zip) öffnen",
  "project.needsMap": "Bitte zuerst eine Verschiebungskarte wählen oder hochladen.",
  "project.needsModel": "Bitte zuerst ein Modell laden (oder den Standard-Würfel verwenden).",
  "project.saveFailed": "Projekt konnte nicht gespeichert werden: {msg}",
  "project.openFailed": "Projekt konnte nicht geöffnet werden: {msg}",
  "project.cubeMaskWarning": "Auf dem Standard-Würfel wurden Masken gemalt. Laden Sie eine echte .stl-/.obj-/.3mf-Datei, bevor Sie ein Projekt mit Masken speichern, oder löschen Sie die Masken. (Die Dreiecksreihenfolge ändert sich beim erneuten STL-Export des Würfels.)",
  ...
  "tooltips.fixedWorldTexture": "Wenn aktiv, wird der UV-Abstand mit einer festen Länge in Millimetern statt der größten Bemaßung des Teils normiert – dasselbe Profil wirkt auf verschiedenen Meshes ähnlich groß. Zylinder- und Kugelmodus nutzen weiterhin mesh-basierte Radien.",
