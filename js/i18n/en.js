export default {
  ...
  "project.hint": "Save or restore the mesh, texture settings, and surface masks in one file.",
  "project.save": "Save project…",
  "project.saveTitle": "Download a .zip with your model, profile, and painted surface masks",
  "project.open": "Open project…",
  "project.openTitle": "Open a previously saved BumpMesh project (.zip)",
  "project.needsMap": "Select or upload a displacement map before saving a project.",
  "project.needsModel": "Load a model (or use the default cube) before saving a project.",
  "project.saveFailed": "Could not save project: {msg}",
  "project.openFailed": "Could not open project: {msg}",
  "project.cubeMaskWarning": "Surface masks were painted on the default cube. Load a real .stl / .obj / .3mf file before saving a project with masks, or clear the masks first. (Triangle order changes when the cube is re-exported as STL.)",
  ...
  "tooltips.fixedWorldTexture": "When enabled, UV spacing uses a fixed length in millimetres instead of the part’s largest dimension, so the same profile looks similar in physical size on different meshes. Cylindrical and spherical modes still use mesh-based radii.",
